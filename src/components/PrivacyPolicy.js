...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      <div className=" scroll-smooth  lg:px-[8%] mt-[60px] bg-[#F9F9F9]">
      <Heading className="" black={"Privacy"} blue={"Policy"} />
        <p className="font-merriweather mx-auto text-justify md:pr-10 lg:mt-10 md:w-full  sm:mx-5 "><span className="font-bold" >Purpose and Scope :</span><br /> Mayhem Shield is a distributor and reseller of IT products and services to other corporations and legal entities, headquartered in the United States but with Subsidiaries all around the world (a list of which is available upon request). Mayhem Shield delivers global technology and supply chain services to support cloud aggregation, cybersecurity solutions, data center management, logistics, technology distribution, mobility device life-cycle, and training to our enterprise customers. For more information about Mayhem Shield, please see the " ” section of our Website.
          <br />
          <br />
          Mayhem Shield provides enterprise customers with the ability to purchase or access a variety of product and service offerings made available by Mayhem Shield and various third-party providers (“Offerings”) both directly from Mayhem Shield and through resellers and distributors. EACH OFFERING MAY BE SUBJECT TO OFFERING-SPECIFIC PRIVACY POLICIES, WHICH MAY SUPERSEDE OR COMPLEMENT THE TERMS OF THIS PRIVACY STATEMENT. MAYHEM SHIELD ENCOURAGES YOU TO CAREFULLY READ THE PRIVACY POLICY OF ANY OFFERING BEFORE ACCESSING OR USING THAT OFFERING.
          <br />
          <br />
          ...
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>Each Offering may include its own specific privacy policy. You should carefully read the privacy policy of any Offering before accessing or using that Offering.</li> <br />
            <li>•	We may collect both Personal Data and other information about you through a variety of sources, including Personal Data we have collected directly from you and your devices, whether online or offline. We may also combine it with information we receive about you from other sources, such as Subsidiaries, publicly available information sources (including information from your publicly available social media profiles), and other third parties.</li> <br />
            <li>We will not use or share your Personal Data except as described in this Privacy Statement.</li> <br />
            <li>The failure to provide us with your accurate and up-to-date Personal Data may interfere with our ability to conduct business with you, such as purchasing Offerings or process your transactions.</li> <br />
            <li>Where applicable, we honor opt out instructions from you for certain uses of your Personal Data under this Privacy Statement, such as, for example, when you opt out of receiving marketing email communications from us or request us to delete your Personal Data.</li> <br />
            <li>We use technical and organizational controls designed to secure and protect your Personal Data, but we cannot ensure or warrant that your Personal Data will be completely secure from misappropriation by hackers or from other nefarious or criminal activities.</li> <br />
          </ul>
          1. General Principles for the Processing of Personal Data
          <br />
          <br />
          Personal Data will be collected, stored, processed and transmitted in accordance with Mayhem Shield’s established policies and applicable federal, state, local and international laws, rules and regulations.
          <br />
          <br />
          The principles of Mayhem Shield with respect to the processing of Personal Data are as follows: (1) Personal Data will be processed fairly and lawfully, (2) Personal Data will be collected for specified, explicit, and legitimate purposes and not further processed for incompatible purposes, (3) Personal Data collected by Mayhem Shield will be adequate, relevant, and not excessive in relation to the purposes for which it is collected, (4) Personal Data collected by Mayhem Shield will be accurate and, where necessary, kept up to date to the best of our ability, (5) Personal Data will be protected against unauthorized access and processing using appropriate technical and organizational security measures and controls; and (6) Personal Data collected by Mayhem Shield will be retained as identifiable data for no longer than necessary to serve the purposes for which the Personal Data was collected.
          <br />
          <br />
          If Mayhem Shield engages in the processing of Personal Data for purposes other than those specified in this Privacy Statement, Mayhem Shield will provide a notice of these changes, the purposes for which the Personal Data will be used, and the recipients of Personal Data.
          <br />
          <br />
          2. Collection of Personal Data
          <br />
          <br />
          Mayhem Shield may collect Personal Data about you from a variety of sources, including, directly from you, from other users, from resellers and distributors, from our vendors, from our service providers, from third-party information providers, from our customers, from our Subsidiaries, and through the operation of the Website.
          <br />
          <br />
          “Personal Data” collected by or on behalf of Mayhem Shield includes, depending on the nature of your interactions with us:
          <br />
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>“Identity Data” such as first name, last name, username or similar identifier, title, company name, and government issued identification number.</li> <br />
            <li>“Contact Data” such as billing address, shipping address, email address and telephone numbers.</li> <br />
            <li>“Financial Data” such as bank account, payment card details and credit history.</li> <br />
            <li>“Transaction Data” such as details about payments to and from you and other details of products and services you have purchased from us.</li> <br />
            <li>“Technical Data” such as internet protocol (IP) address, your login data, browser type and version, time zone setting and location, browser plug-in types and versions, operating system and platform and other technology on the devices you use to access our websites.</li> <br />
            <li>“Profile Data” such as your username and password to access the Website, account number, purchases or orders made by you, your interests, preferences, feedback and survey responses.</li> <br />
            <li>“Usage Data” such as information about how you use our Website, products and services, as well as information about what you type into web chats and form fields on our Website, as well as your keystrokes and mouse movements on our Website.</li> <br />
            <li>“Preference Data” such as your preferences in receiving marketing from us and our third parties, and your communication preferences.</li> <br />
            <li>“Professional Data” such as your company affiliation, job title, office location, and professional contact information if you interact with us on behalf of a business customer or vendor.</li> <br />
            <li>“Sensitive Personal Data” such as government issued identification number, username and password to access an Mayhem Shield account, bank account information, payment card details. This information may be subject to additional protections and privacy rights, as described below.</li> <br />
            <li>Other information that we collect with your consent from time to time.</li> <br />
          </ul>
          <br />
          Mayhem Shield collects Personal Data as follows and from the following categories of sources:
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>
            ...
            <li>From Resellers and Distributors. We may obtain Personal Data about you from the resellers and distributors that purchase Offerings available from us and provide such Offerings to you.</li><br />
            <li>From Our Vendors. We may obtain Personal Data about you from the third-party vendors that make Offerings available through us.</li><br />
            <li>From Our Service Providers. We may obtain Personal Data about you from the service providers that help us operate our business. For example, service providers that host or maintain our Website or send promotional emails for us may give us Personal Data. Payment processing providers may collect your payment information. Our marketing agencies, advertising technology vendors, analytics providers, and other service providers may also provide us with Personal Data about you.</li><br />
            <li>From Customers. We may obtain Personal Data about you from third-party customers that contract with us for services. For example, we may provide fulfillment services on behalf of other companies where we will pick, pack, and ship a physical product to you. In this scenario we will receive your name, mailing address, and order information, and will only process your Personal Data to facilitate the services on behalf of the customer.</li><br />
            <li>From Data Providers. Mayhem Shield may also obtain or license Personal Data from third parties that maintain information about you and that have the right to provide that Personal Data to us. For example, if you register for the Website using a third-party service or through a third-party website or service, the information you provide to that third-party will be provided to us to establish your account on the Website. We may also contract with companies that are in the business of providing information to businesses such as ours to verify certain information about you or obtain information.</li><br />
            <li>From Publicly Available Sources. We may also obtain Personal Data from publicly-available sources such as open government databases or other data in the public domain.</li><br />
            <li>From Affiliates and Subsidiaries. We may obtain Personal Data from our Affiliates and Subsidiaries.</li><br />
            <li></li><br />
          </ul>
          ...
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li> Strictly necessary cookies. These are cookies that are required for the operation of our Website. They include, for example, cookies that enable you to log into secure areas of our Website or use a shopping cart.
            </li><br />
            <li>Analytical/performance cookies. These cookies are used to analyze how the Website is used and to monitor its performance, which allows us to improve your experience in using the Website. These cookies help us to tailor the content of Website to reflect what users find most interesting and to identify when technical issues with the Website arises. We may also use this data to compile reports to help us to analyze how the Website is used, what the most common issues are and how we can improve the Website.</li><br />
            <li>Functional/tracking cookies. These cookies enable us to recognize repeat visitors to our Websites. By matching an anonymous, randomly generated identifier, a tracking cookie keeps track of where a user of our Websites came from, what search engine they may have used, what link they clicked on, what keyword they used and where they were in the world when they accessed the Website. By monitoring this data, we can make improvements to our Website.</li><br />
          ...
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>Session cookies. These cookies are used 'in-session' each time you visit and then expire when you leave a Website or shortly thereafter: they are not stored on your Device permanently, do not contain any Personal Data, and help by minimizing the need to transfer Personal Data across the internet. These cookies can be deleted, or you can refuse to allow their use, but this will hamper the performance and your experience in using the Website. These cookies also take time stamps that record when you access the Website and when you leave the Website.</li><br />
            <li>Persistent Cookies. This type of cookie is saved on your Device for a fixed period (sometimes for a few hours, sometimes for a year or longer) and is not deleted when the browser is closed. Persistent cookies are used where we need to remember who you are for more than one browsing session. For example, this type of cookie can be used to store your language preferences, so that they are remembered for the next visit to the Website.</li><br />
          </ul>
          ...
          <br />
          <br />
          Mayhem Shield uses Personal Data we collect to operate our business and provide you with Offerings, which includes using this data to improve our Offerings and personalize your experiences. We also may use the data to communicate with you, for example, informing you about your account and product information.
          <br />
          <br />
          Depending on the nature of your interactions with us, Mayhem Shield may use your Personal Data, including Sensitive Personal Data, for a variety of purposes (the “Purposes”), including to:
          <br />
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>Register you as a new customer;</li><br />
            <li>Provide, maintain, and improve the Website and our Offerings, including to operate certain features and functionality of the Website;</li><br />
            <li>	Understand user preferences to enhance users’ experience with Mayhem Shield and its Subsidiaries, contractors, and business partners;</li><br />
            <li>Research and analyze the effectiveness of the Website and the marketing, advertising and sales efforts of Mayhem Shield, its Subsidiaries, contractors, and business partners including through the use of automated systems that analyze data using machine learning and other analytic techniques;</li><br />
            <li>Collect account receivables owed by customers of Mayhem Shield;</li><br />
            <li>Process orders, deliveries and payments made through the Website;</li><br />
            <li>Develop additional Offerings;</li><br />
            <li>Comply with a legal obligation or respond to lawful requests by public authorities (including national security or law enforcement requirements);</li><br />
            <li>Manage our everyday business needs;</li><br />
            <li>Enforce compliance with our Terms of Use and applicable law;</li><br />
            <li>Prosecute and/or defend a court, arbitration or similar legal proceedings;</li><br />
            <li>For security and safety purposes, such as protecting the Website and our company against cyber threats, protecting our rights and the rights of our customers, and detecting, investigating, and preventing fraud or other illegal activities;</li><br />
            <li>Communicate directly with you by sending you newsletters, surveys, promotions and special offers or information about new products and services on an ongoing basis in accordance with your marketing preferences. You can unsubscribe from our marketing communications at any time by clicking “Unsubscribe” at the bottom of the email or by contacting us using the “Questions and Contact Information” details below.</li><br />
            <li>Communicate directly with you by phone to respond to customer service inquiries or comments through the Website, social media or otherwise, to discuss issues relating to your account or the Website, and to provide customer support.</li><br />
            <li>Deliver advertising to you, including to help advertisers and publishers serve and manage ads on the Website or on third-party sites, and to tailor ads based on your interests and browsing histories. Please see the section on Cookies and Other Website Usage Information for additional information related to such advertising and your related controls;</li><br />
            <li>Monitor and record your call, emails and text messages, social media messages, chat box and other communications (as permitted by local law) in relation to your dealings with us;</li><br />
            <li>Verify your identity before responding to privacy requests you make regarding your Personal Data;</li><br />
            <li>Comply with our contractual or legal obligations to share data with credit reference agencies, fraud prevention agencies and law enforcement agencies;</li><br />
            <li>Compile aggregated statistics about the operation and use of our Website and to better understand the preferences of the visitors of our Website; and</li><br />
            <li>Other Purposes: To carry out other legitimate business purposes, as well as other lawful purposes about which we will notify you.</li><br />
          </ul>
          <br />
          ...
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>manage and take decisions about your account, including assessing your creditworthiness;</li><br />
            <li>prevent criminal activity, fraud and money laundering;</li><br />
            <li>check your identity and verify the accuracy of the information you provide to us; and</li><br />
            <li>trace debtors and recover debts.</li><br />
          </ul>
          ...
          <br />
          <br />
          <span className="underline underline-offset-4"> Do Not Track.</span>{" "}
          Certain web browsers and other devices you may use to access the Website may permit you to indicate your preference that you do not wish to be “tracked” online. At this time, the Website does not respond to “Do Not Track” signals. We do not modify your experience on the Website or modify the Personal Data we collect from you through the Website, based on whether such a preference is indicated.
          <br />
          <br />
          <span className="underline underline-offset-4">Preference Center.</span>{" "}Many of our Subsidiaries utilize a preference center that allow you to opt out or opt down to receiving messages and communications from us. You can select or unselect your communication preferences at any time through the web form provided by that Affiliate.
          <br />
          <br />
          ...
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li>sending an email to <a href="mailto:privacy@mayhemshield.com" className='text-blue-500 underline underline-offset-4'>privacy@mayhemshield.com</a></li>
          </ul>
          ...
          <br />
          <br />
          <span className="underline underline-offset-4">United States Privacy Rights</span>
          <br />
          <br />
          ...
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            ...
            <li><span className="underline underline-offset-4 italic ">Access / Right to Know:</span> You may have the right to confirm whether we process Personal Data about you and to request that we disclose to you the following: (i) the categories of Personal Data that we have collected about you (including Sensitive Personal Data); (ii) the categories of sources from which we have collected Personal Data about you; (iii) the business or commercial purpose for collecting or selling your Personal Data; (iv) the categories of Personal Data that we have sold about you and the categories of outside parties to whom the Personal Data was sold; (v) the categories of Personal Data that we have disclosed about you for our business purposes and the categories of service providers to whom the Personal Data was disclosed; (vi) a portable copy of the specific pieces of Personal Data that we have collected about you; and (vii) information about the logic involved in any automated decision-making processes used by us (if applicable), as well as a description of the likely outcome of the process with respect to you.</li>
            <li><span className="underline underline-offset-4 italic ">Correct or update your Personal Data:</span> You may have the right to request that we correct, update, or modify the Personal Data we maintain about you.</li>
            <li><span className="underline underline-offset-4 italic ">Delete your Personal Data: </span> You may have the right to request that we correct, update, or modify the Personal Data we maintain about you.</li>
            <li><span className="underline underline-offset-4 italic ">Do Not Sell My Personal Data or Share my Personal Data for Behavioral Advertising: </span> You may have the right to opt-out of the sale of your Personal Data and the sharing of your Personal Data for cross-context behavioral advertising by clicking the “Do Not Sell or Share My Personal Information” link in the footer of this webpage. If you would like to opt out of cookie-based tracking for advertising purposes (which could be a “sale” or “sharing” under applicable law), you will need to update your cookie preferences on this webpage or through the “Do Not Sell or Share My Personal Information” link in the footer of this page.</li>
            <li><span className="underline underline-offset-4 italic ">Opt-out of automated decision-making: </span> You may have the right to request to opt-out of any profiling or automated decision-making, to the extent we engage in those processing activities and subject to any limitations under applicable privacy laws.</li>
            <li><span className="underline underline-offset-4 italic ">Limit the use of my Sensitive Personal Data:</span> In relation to the Sensitive Personal Data identified in Section 2 above, you may be able to request that we limit our use and sharing of such data to those purposes specified under applicable privacy laws.</li>
          </ul>
          <br />
          <span className="underline underline-offset-4 italic ">European Economic Area (EEA) / United Kingdom (UK) and Switzerland Privacy Rights</span>
          <br />
          <br />
          ...
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5">
            <li><span className="underline underline-offset-4 italic ">Access and portability of your Personal Data: </span>You have the right to obtain access to your Personal Data (if we are processing it). You can obtain a portable copy of your Personal Data.</li>
            <li><span className="underline underline-offset-4 italic ">Rectification of your Personal Data:</span> You can request that we correct, update, or modify the Personal Data we maintain about you.</li>
            <li><span className="underline underline-offset-4 italic ">Erasure of your Personal Data:</span> You can request that we erase the copies of your Personal Data that we maintain, subject to certain exceptions and limitations.</li>
            <li><span className="underline underline-offset-4 italic ">Object to processing: </span>You can object to the processing of your Personal Data where we carry out such processing on the grounds of our legitimate interests.</li>
            <li><span className="underline underline-offset-4 italic ">Restrict processing: </span>You can ask us to restrict processing of your Personal Data or block the further use of your Personal Data. When processing is restricted, we can still store your Personal Data.</li>
            <li><span className="underline underline-offset-4 italic ">Refuse or withdraw consent:</span> If we have collected and processed your Personal Data with your consent, then you can withdraw your consent at any time. Withdrawing your consent will not affect the lawfulness of any processing we conducted prior to your withdrawal, nor will it affect processing of your Personal Data conducted in reliance on lawful processing grounds other than consent.</li>
            <li><span className="underline underline-offset-4 italic ">Complaints:</span> You have the right to complain to a data protection authority about our collection and use of your Personal Data, including if you are not satisfied with our response to your privacy requests. For more information, please contact your local data protection authority. (Contact details for data protection authorities in the European Economic Area and the UK are available <a href="/lets-talk " className='text-blue-500 '>here</a>.)</li>
          </ul>
          <span className="underline underline-offset-4 italic ">  Identity of the Controller for purposes of European data protection law. </span>The controller for any Personal Data processed by us is the Mayhem Shield Affiliate in the European Economic Area country, UK or Switzerland collecting the Personal Data. If you have any questions about the Personal Data you have submitted to the respective Affiliate, please contact the relevant Affiliate.
          <br />
          <br />
          <span className="underline underline-offset-4 italic ">Legal Basis for Processing Personal Data (EEA, Switzerland and UK Visitors).</span> Our legal basis for collecting and using the Personal Data described above will depend on the Personal Data concerned and the specific context in which we collect it. However, we will normally collect Personal Data from you only (i) where we need the Personal Data to perform a contract with you (such as to fulfill your purchase of an Offering), (ii) where the processing is in our legitimate interests and not overridden by your rights, or (iii) where we have your consent to do so. In some cases, we may also have a legal obligation to collect Personal Data from you or may otherwise need the Personal Data to protect your vital interests or those of another person.
          <br />
          <br />
          ...
          <br />
          <br />
          <span className="underline underline-offset-4 italic ">Other Jurisdiction Privacy Rights</span>
          <br />
          <br />
          ...
          <br />
          <br />
          <span className="font-bold">9. Other Important Privacy Information</span>
          <br />
          <br />
          <span className="underline underline-offset-4"> Security of Personal Data. </span>
          Mayhem Shield uses technical and organization controls and measures designed to secure and protect your Personal Data from unauthorized loss, misuse, and disclosure, such as strong user access controls, segmented network architecture, and comprehensive employee policies and training. Unfortunately, no data transmitted over or accessible through the Internet can be guaranteed to be 100% secure. As a result, while Mayhem Shield attempts to protect all Personal Data, Mayhem Shield cannot ensure or warrant that Personal Data will be completely secure from misappropriation by hackers or from other nefarious or criminal activities, or in the event of a failure of computer hardware, software, or a telecommunications network. Mayhem Shield will notify you in the event we become aware of a security breach involving your personally identifiable information (as defined by the applicable foreign, federal, state, and local laws) stored by or for us, in accordance with applicable laws.
          <br />
          <br />
          <span className="underline underline-offset-4"> Compliance. </span>
          Mayhem Shield will use a self-assessment approach to verify compliance with this Privacy Statement and periodically verify that the Privacy Statement is accurate, comprehensive for the information intended to be covered, prominently displayed, implemented and accessible. If you believe that your Personal Data has been processed or disclosed in violation of this Privacy Statement, Mayhem Shield encourages you to raise any concerns using the contact information provided in this Privacy Statement under the “Questions and Contact information” heading below. Mayhem Shield will investigate and attempt to resolve any complaints and disputes regarding use and disclosure of Personal Data.
          <br />
          <br />
          <span className="underline underline-offset-4">Accuracy.</span> It is your responsibility to provide Mayhem Shield with accurate Personal Data. Except as otherwise set forth in this Privacy Statement, Mayhem Shield shall only use Personal Data in ways that are compatible with the purposes for which it was collected or subsequently authorized by you. To the extent necessary for these purposes, Mayhem Shield shall take reasonable steps to ensure that Personal Data is accurate, complete, current and relevant to its intended use.
          <br />
          <br />
          <span className="font-bold">10. International Data Transfers</span>
          <br />
          <br />
          ...
          <br />
          <br />
          If you are a resident of the European Union or the UK, all the Personal Data related to you and received and stored by Mayhem Shield are erased after 5 years, save for any Personal Data in documents and files we must keep for a longer period under applicable laws. For example, we cannot erase personal data appearing on VAT invoices before we can delete the invoices from our systems.
          <br />
          <br />
          <span className="font-bold">12. Not for Children</span>
          <br />
          The Website is intended solely for use by individuals 18 years of age and older and thus is not directed to children under 18 years of age. Mayhem Shield does not knowingly solicit or collect Personal Data from children under 18 years of age.
          <br />
          <br />
          <span className="font-bold">13. Third-party Websites</span>
          <br />
          <br />
          In addition to providing access to Offerings, the Website may include links to other websites and web services. This Privacy Statement does not apply to those websites and services and the privacy practices of those websites and services may differ from those described in this Privacy Statement. If you submit Personal Data to any of those other websites or services, your Personal Data is governed by the privacy policies applicable to those websites and services. Mayhem Shield encourages you to carefully read the privacy policy of any website or web service you visit.
          <br />
          <br />
          <span className="font-bold">14. Revisions and Updates to this Privacy Statement</span>
          <br />
          Mayhem Shield may from time to time revise this Privacy Statement in its sole and absolute discretion to reflect changes in our business practices or new disclosure requirements under applicable privacy laws. If we revise this Privacy Statement, we will notify you by posting the updated Privacy Statement on this Website and/or by sending you a notification by email, as required by applicable privacy laws. Changes to the Privacy Statement will become effective and will apply to the information collected starting on the date Mayhem Shield posts the revised Privacy Statement on the Website. If we are required by applicable data protection laws to seek your consent to any changes in use of your Personal Data described in our updated Privacy Statement, then we will do that.
          <br />
          <br />
          <br />
          <ul className="list-disc lg:mx-10 md:mx-5 sm:mx-5"></ul>
          <br />
        </p>
      </div>
      <a href={`#top`}>
        <p className="text-4xl fixed bottom-14 right-5">
          <AiFillCaretUp />
        </p>
      </a>
      <a href={`#down`}>
        <p className="text-4xl fixed bottom-5 right-5">
          <AiFillCaretDown />
        </p>
      </a>
